          ...
          <div className="flex justify-end items-center py-2">
            <div className="flex items-center gap-6">
              <a
                ...
                className="flex items-center gap-2 hover:text-blue-600 transition-colors text-blue-700 font-medium text-sm"
              >
                ...
                return (
                  <Link key={link.href} href={link.href}>
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className={`relative px-4 py-2 mx-1 rounded-lg font-semibold text-base transition-all duration-300 ${isActive
                          ? "text-blue-600"
                          : "text-slate-700 hover:text-blue-600"
                        }`}
                    >
